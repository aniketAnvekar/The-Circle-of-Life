...
def draw_next_graph(canvas, networkx_graph, axis, node_positions, xlim, ylim, predator, prey, agent):
    axis.cla()
    color_map = [
        'blue' if node == agent.position else 'red' if node == predator.position else 'green' if node == prey.position else 'yellow'
